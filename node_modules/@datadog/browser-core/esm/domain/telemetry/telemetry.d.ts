...
export declare function startTelemetry(telemetryService: TelemetryService, configuration: Configuration, reportError: (error: RawError) => void, pageMayExitObservable: Observable<PageMayExitEvent>, createEncoder: (streamId: DeflateEncoderStreamId) => Encoder): Telemetry;
export declare function startTelemetryCollection(telemetryService: TelemetryService, configuration: Configuration, observable: Observable<TelemetryEvent & Context>): {
    setContextProvider: (key: string, contextProvider: () => ContextValue | undefined) => Map<string, () => ContextValue | undefined>;
    enabled: boolean;
};
